...
export default async function AdminDashboard() {
  ...
  const statCards = [
    { label: 'Podnety na schválenie', value: stats.pending, color: 'text-[#818cf8]', href: '/admin/podnety' },
      ...
      {recent.length > 0 && (
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/podnety" className="text-xs text-[#818cf8] hover:text-[#a5b4fc] transition-colors">
              Všetky podnety →
            </Link>
          </div>
