          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row gap-3 justify-center mb-16">
            <a href="#program">
              <Button
                size="lg"
                data-cursor
                className="group relative overflow-hidden bg-orange-500 hover:bg-orange-400 text-white border-0 shadow-2xl shadow-orange-500/25 px-9 py-6 text-base font-bold w-full sm:w-auto transition-all duration-300 hover:scale-[1.04] hover:shadow-orange-500/40"
              >
